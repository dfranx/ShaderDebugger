...
namespace pp
{
    ...
    public:
        ...
        void Process(const std::string& src, const std::string& fname, TokenSequence& os);
        ...
        void ParseVersion(TokenSequence ls);
        ...
        void IncludeSource(TokenSequence& is, const std::string* src, const std::string* filename);
        bool ParseIdentList(ParamList& params, TokenSequence& is);

        inline const MacroMap& GetMacroList() { return macroMap_; }
